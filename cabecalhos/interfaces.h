...
class InterfaceServicoVocabulario {
 public:
  /**
   * @brief função abstrata que retorna todos os vocabulários armazenados.
   *
  ...
  /**
   * @brief função abstrata que retorna todos os termos armazenados.
   *
  ...
  /**
   * @brief função abstrata que retorna todos os termos de determinado vocabulário.
   *
  ...
  /**
   * @brief função abstrata que retorna a quantidade de termos associados a determinada definição.
   *
  ...
  /**
   * @brief função abstrata que retorna todas as definições armazenadas.
   *
  ...
  /**
   * @brief função abstrata que retorna todas as definições de determinado termo.
   *
  ...
  /**
   * @brief função abstrata que retorna a definição de determinado vocabulário.
   *
  ...
  /**
   * @brief função abstrata que cadastra um usuário como administrador de determinado vocabulario.
   *
  ...
  /**
   * @brief função abstrata que cadastra um usuário como desenvolvedor de determinado vocabulario.
   *
   * @return Resultado sucesso ou falha ao cadastrar o usuário.
   */
  ...
  /**
   * @brief função abstrata que retorna a quantidade de desenvolvedores de determinado vocabulário.
   *
  ...
  /**
   * @brief função abstrata que cria um termo.
   *
  ...
  /**
   * @brief função abstrata que edita um termo.
   *
  ...
  /**
   * @brief função abstrata que exclui um termo.
   *
  ...
  /**
   * @brief função abstrata que cria uma definição.
   *
  ...
  /**
   * @brief função abstrata que edita uma definição.
   *
  ...
  /**
   * @brief função abstrata que exclui uma definição.
   *
  ...
  /**
   * @brief função abstrata que cria um vocabulário.
   *
  ...
  /**
   * @brief função abstrata que edita um vocabulário.
   *
  ...
  /**
   * @brief função abstrata que exclui um vocabulário.
   *
  ...
  /**
   * @brief função abstrata que associa uma definição a um termo.
   *
...
class InterfaceApresentacaoVocabulario {
 public:
  ...
  /**
   * @brief função abstrata que seta o controle para a interface de serviço de vocabulário.
   *
   */

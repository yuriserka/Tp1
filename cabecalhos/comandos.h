...
/**
 * @brief Classe abstrata dos comandos de apresentação de vocabulario.
 * 
 */
...
/**
 * @brief Classe abstrata dos comandos de apresentação de vocabulario que precisam de um email para executar.
 * 
 */
...
/**
 * @brief Classe abstrata dos comandos de apresentação de vocabulario que precisam de um vocabulário para executar.
 * 
 */
